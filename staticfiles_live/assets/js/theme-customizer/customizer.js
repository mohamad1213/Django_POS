if (localStorage.getItem("color"))
  $("#color").attr(
    "href",
    "/zeta/zetaapp/static/assets/css/" + localStorage.getItem("color") + ".css"
  );
...
$(document).ready(function () {
  ...
  $(".customizer-color li").on("click", function () {
    ...
    $("#color").attr(
      "href",
      "/zeta/zetaapp/static/assets/css/" + color + ".css"
    );
  ...
  $(".sidebar-type li").on("click", function () {
    ...
    switch (type) {
      ...
      case "normal-sidebar": {
        ...
        $(".logo-wrapper")
          .find("img")
          .attr("src", "/zeta/zetaapp/static/assets/images/logo/logo.png");
